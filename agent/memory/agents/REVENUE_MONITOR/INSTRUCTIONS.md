...
curl -s -X POST http://127.0.0.1:8081/api/companies/2fb13f91-fa14-4a2f-9497-6601e9a171d9/issues \
  ...
  -d "{\"projectId\":\"898eaef0-6dc2-4e11-beac-9f74e7240982\",\"title\":\"REV-1: $(description)\",\"description\":\"$(full context)\",\"assigneeAgentId\":\"3e6e6a26-668f-425c-b44f-fbf2217edf3b\"}"

For REV-2 (nearLimitIPs > 30 OR revenue drop > 40%):
curl -s -X POST http://127.0.0.1:8081/api/companies/2fb13f91-fa14-4a2f-9497-6601e9a171d9/issues \
  -H "Content-Type: application/json" \
  -d "{\"projectId\":\"898eaef0-6dc2-4e11-beac-9f74e7240982\",\"title\":\"REV-2: $(description)\",\"description\":\"$(full context)\",\"assigneeAgentId\":\"3e6e6a26-668f-425c-b44f-fbf2217edf3b\"}"
