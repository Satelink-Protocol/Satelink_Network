...
/*
 * Satelink OS — Overview dashboard.
 * 6 sections, each fetches its own data independently with explicit
 * loading / error states. Real data only — collected revenue is shown
 * from on-chain truth, metered epoch revenue is labeled as unbilled.
 *
 * All fetches use relative paths: next.config.ts rewrites proxy
 * /api/*, /rpc/*, /system/* to https://rpc.satelink.network.
 */
...
function useEndpoint<T>(urls: string[]): WidgetState<T> & { name: string } {
...
function FreeTierMonitor() {
  // /system/free-tier is the primary endpoint; /stats/free-tier is the
  // curl-verified fallback serving the same counters.
      ...
      <div className="os-shell">
        <div className="os-header">
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <a href="/satelink/os/nodes" className="btn btn-secondary">
              Nodes
            </a>
