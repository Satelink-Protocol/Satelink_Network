-- 040 — Pricing V2 (feat/pricing-v2-dodo). Additive; api_credits / plans /
-- plan_entitlements untouched. Applied idempotently at first use by
-- src/pricing_v2/schema.mjs. FOUNDER REVIEW.
