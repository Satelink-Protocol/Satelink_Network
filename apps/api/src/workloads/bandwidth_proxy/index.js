...
export function createBandwidthRouter(pool, redis) {
  ...
  router.post('/proxy', async (req, res) => {
    ...
    try {
      ...
      await pool.query('INSERT INTO revenue_events_v2 (op_type, client_id, amount_usdt, status, request_id, created_at, is_test_data, is_billable) VALUES ($1,$2,$3,$4,$5,$6,$7,false)', ['bandwidth', apiKey || 'public', cost, 'completed', revRequestId, Math.floor(Date.now()/1000), isTestData])
  ...
  router.post('/scrape', async (req, res) => {
    ...
    try {
      ...
      await pool.query('INSERT INTO revenue_events_v2 (op_type, client_id, amount_usdt, status, request_id, created_at, is_test_data, is_billable) VALUES ($1,$2,$3,$4,$5,$6,$7,false)', ['scrape', apiKey || 'public', '0.001', 'completed', revRequestId, Math.floor(Date.now()/1000), isTestData])
      // M3 shadow ledger — flag-gated, isolated pool, never throws.
