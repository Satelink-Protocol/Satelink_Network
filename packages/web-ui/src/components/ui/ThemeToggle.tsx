...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex size-9 items-center justify-center rounded-[var(--sl-radius-sm)] text-sl-text-muted transition-colors hover:bg-sl-surface-hover hover:text-sl-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sl-accent/45",
        className
      )}
    >
